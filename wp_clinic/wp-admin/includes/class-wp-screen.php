...
final class WP_Screen {
	 ...
	 * This is called in admin-header-index.php after the menu parent for the screen has been determined.
	 *
	 * @since 3.3.0
	 *
	 ...
	 * Call this in template files after admin.php is loaded and before admin-header-index.php is loaded to add screen options.
	 *
	 * @since 3.3.0
	 *
	 ...
	 * Call this in template files after admin.php is loaded and before admin-header-index.php is loaded to add a sidebar to the contextual help.
	 *
	 * @since 3.3.0
	 *
