                ...
                <ul class="col menu text-left">
                    <li>
                        ...
                        <ul class="menu-dropdown">
                            <li><a href="html/index.html">Home Style 1</a></li>
                            ...
                            <li class="row">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="html/gallery.html">Gallery Style 1</a></li>
                                        <li><a href="html/gallery-1.html">Gallery Style 2</a></li>
                        ...
                        <ul class="menu-dropdown">
                            ...
                            <li>
                                ...
                                <ul class="menu-dropdown">
                                    ...
                                    <li><a href="html/service.html">Single Service Page</a></li>
                                </ul>
                            </li>
                            <li>
                                <a>Service Style 3</a>
                            ...
                            <li><a href="html/service.html">Service Detail</a></li>
                        </ul>
                    </li>
                    <li class="menu-megamenu-li">
                    ...
                    <li>
                        ...
                        <ul class="menu-dropdown">
                            <li>
                                <a>Blog Style 1</a>
                                <ul class="menu-dropdown">
                                    <li><a href="html/blogs-1.html">Blog style 1</a></li>
                            ...
                            <li><a href="html/blog-1.html">Blog Details 1</a></li>
                    ...
                    <li>
                        ...
                        <ul class="menu-dropdown">
                            <li><a href="html/login.html">Login Page</a></li>
    ...
    <div class="flexslider slider-wrapper">
        <ul class="slides">
            <li>
                ...
                <div class="slider-backgroung-image" style="background-image: url(<?php echo get_template_directory_uri()?>/uploads/slider-1.jpg);"></div>
            ...
            <li>
                ...
                <div class="slider-backgroung-image" style="background-image: url(<?php echo get_template_directory_uri()?>/uploads/slider-2.jpg);"></div>
                <!-- Make an Appointment  Button -->
            ...
            <li>
                ...
                <div class="slider-backgroung-image" style="background-image: url(<?php echo get_template_directory_uri()?>/uploads/slider-3.jpg);"></div>
                <!-- Make an Appointment  Button -->
                <div class="slider-button">
                    ...
                    <div class="tbl">
                        <div class="tbl-row">
                            <ul class="tbl-cell">
                                ...
                                <li><a href="html/privacy-policy.html">Privacy policy</a></li>
                                <li><a href="html/terms-conditions.html">Terms condition</a></li>
                                <li><a href="html/faq.html">Faq</a></li>
                            </ul>
                            <ul class="tbl-cell">
