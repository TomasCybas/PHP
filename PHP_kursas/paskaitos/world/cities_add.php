...
if(isset($_POST['add'])){
    ...
    $db -> query("INSERT INTO city (country_code, name, district, population ) 
    VALUES ('$code', '$name', '$district', '$population')");
       ...
       <div class="row">
        ...
        <div class="col-md-12 order-md-1">
          ...
          <form method="post">
            ...
            <hr class="mb-4">
            <button class="btn btn-primary btn-lg btn-block" type="submit" name="add">Išsaugoti</button>
          </form>
        </div>
      </div>
    </div>
