        ...
        <div id="page">		
            ...
            <div class="page-header page-title-left">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="title">Start-up Meet up</h1>
							<ul class="breadcrumb">
								<li>
			...
			<section class="page-content-wrapper page-section">
				<div class="container">
					<div class="row">
						<div class="col-md-9 post-single post-classic">
							<div class="post-item">
								<div class="image">
									<!-- Image -->
									<img class="img-responsive" src="img/sections/blog/big/1.jpg" alt="" title="" width="900" height="450" />
								</div>
								<div class="description">
									...
									<blockquote>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repudiandae odit iste exercitationem praesentium deleniti nostrum laborum rem id nihil tempora.
									</blockquote>
								...
								<div class="meta hidden-xs">
									<!-- Meta Date -->
									<span class="time">
									<i class="fa fa-calendar"></i> April 05, 2016
									</span>
									<!-- Posted By -->
								...
								<div class="col-md-12">
									<div class="author-area about-box light-bg">
										<div class="author-img">
											<img src="img/sections/blog/author/b1.jpg" width="150" height="150" alt="" title="">
										</div>
										<div class="author-comments">
											<h4 class="title">admin</h4>
											<p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla.Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
											<!-- Social Links -->
